...
<?php foreach ($latest_jobs as $latest_job) { ?>
            <div class="job-list">
              <div class="thumb">
                  <a href="job-details.html"><img src="<?php echo base_url(); ?>assets/uploads/job_categories_imge/<?php echo $latest_job->Image ?>" alt="" class="avatar" height="110px" width="110px"></a>
              </div>
              <div class="job-list-content">
                <h4><a href="job-details.html"><?php echo $latest_job->Title ?></a><span class="full-time"><?php echo $latest_job->JobStatus ?></span></h4>
                <p><?php echo $latest_job->Discription ?></p>
                <div class="job-tag">
                  <div class="pull-left">
                    <div class="meta-tag">
                      <span><a href="browse-categories.html"><i class="ti-desktop"></i><?php echo $latest_job->JobCategoryName ?></a></span>
                      <span><i class="ti-location-pin"></i><?php echo $latest_job->Location ?>, LK</span>
                    </div>
                  </div>
          ...
          <div class="col-md-12">
            <div class="showing pull-left">
              <a href="#">Showing <span>4</span> Of <?php echo $job_count ?> Jobs</a>
            </div>                    
