                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="right-sideabr">
                            <div class="inner-box">
       <ul class="lest item">
                                    <li><a class="active" href="resume.html"><b>Welcome <?php echo $this->session->userdata('logged_in')['email']; ?> [ <?php echo $this->session->userdata('logged_in')['user_level']; ?> ]</b></a></li>
                                </ul>
