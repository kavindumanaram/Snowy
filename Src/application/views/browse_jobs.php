...
<button type="button" class="btn btn-common btn-rm" data-toggle="modal" data-target="#myModal">Add New Job</button>						
                  ...
                  <div class="inner-box">
                    ...
                    <ul class="cat-list">
                      ...
                      <li>
                        <a href="#"> <?php echo $job_category->JobCategoryName ?> <span class="num-posts"> <?php echo $job_category->jobCount?> Jobs</span></a>                    
                      </li>
                        <?php } ?>
                    </ul>
                  </div>
                  <div class="inner-box">
                    ...
                    <ul class="cat-list">
                      ...
                      <li>
                        <a href="#"><?php echo $job_status->JobStatus ?> <span class="num-posts"> <?php echo $job_status->jobCount?> Jobs</span></a>                    
                      </li>
                      <?php } ?>
                    </ul>
                  </div>
                  <div class="inner-box">
                    ...
                    <ul class="cat-list">
                      ...
                      <li>
                        <a href="#"><?php echo $job_location->Location; ?><span class="num-posts"> <?php echo $job_location->jobCount?> Jobs</span></a>                    
                      </li>
                      <?php } ?>
                    </ul>
                  </div>
